...
fun ProfileScreen(postsVm: PostsViewModel, themeVm: ThemeViewModel) {
    ...
    Column(
        ...
        // Update these fields with your own details
        Text("Chloe Nicole Monteza", style = MaterialTheme.typography.headlineSmall)
        Text("@cnmonteza64178", style = MaterialTheme.typography.bodyMedium)
        ...
        Row(
            ...
            Switch(
                checked = darkTheme,
                onCheckedChange = { themeVm.onThemeChanged(it) }, // TODO 12b: save the new value
            )
        }
    }
}